...
from cs336_basics.model import Linear, Embedding, SwiGLU, RMSNorm, RotaryPositionalEmbedding, softmax
...
def run_rope(
    ...
    """
    rpe = RotaryPositionalEmbedding(theta=theta, d_k=d_k, max_seq_len=max_seq_len)
